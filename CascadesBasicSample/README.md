...
-- Separating your Panes into seperate QML files
-- Connecting Button click actions created in QML to signals in C++
-- Pushing new Page on a NavigationPane
-- Adding ActionItems to the Action Menu
-- Custom transition animations in QML
