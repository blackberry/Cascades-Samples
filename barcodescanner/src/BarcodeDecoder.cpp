        ...
        m_nbuffers(2)
{
	...
	QObject::connect(m_camera, SIGNAL(cameraOpened()), this,
            SLOT(onCameraOpened()));

    QObject::connect(m_camera, SIGNAL(viewfinderStarted()), this,
            SLOT(viewfinderStarted()));

    QObject::connect(m_camera, SIGNAL(viewfinderStopped()), this,
...
void BarcodeDecoderControl::onPreviewFrameAvailable(
	...
	try {
		...
		QString newBarcodeData = QString::fromStdString(result->getText()->getText().data());
