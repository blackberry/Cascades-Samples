...
config_pri_assets {
    OTHER_FILES += \
        $$quote($$BASEDIR/assets/720x720/ContactScrollView.qml) \
        $$quote($$BASEDIR/assets/ContactItem.qml) \
        $$quote($$BASEDIR/assets/ContactList.qml) \
        $$quote($$BASEDIR/assets/ContactPage.qml) \
        $$quote($$BASEDIR/assets/ContactScrollView.qml) \
