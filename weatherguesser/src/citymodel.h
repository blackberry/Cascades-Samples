...
public:
  ...
  /**
   * This functoin loads all items in the database where favorite=true to the model.
   */
...
private slots:
   ...
   * operation is performed until no more results are avaiable.
   *
...
private:
   ...
   * @param isFavorite If this parameter is true, the city will be a favorite. If false, the city won't be a favourite.
   * @return True if successful, false otherwise.
   */
