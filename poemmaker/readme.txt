PoemMaker - Animations

========================================================================
Sample Description.

The Poem Maker is a simple application with three lines of text (labels) 
and a button. Clicking the button will generate a random "refrigerator" poem.

You will learn how to:
- Add and position basic UI components (Label/Image)
- Attach an event listener that reacts to user interaction
- Play animations
- Use JavaScript functions in QML
