...
config_pri_assets {
    OTHER_FILES += \
        $$quote($$BASEDIR/assets/720x720/BbmProfileBoxScrollView.qml) \
        $$quote($$BASEDIR/assets/BbmProfileBoxScrollView.qml) \
        $$quote($$BASEDIR/assets/NewProfileBoxPage.qml) \
        $$quote($$BASEDIR/assets/ProfileBoxItem.qml) \
        $$quote($$BASEDIR/assets/images/apple.png) \
        $$quote($$BASEDIR/assets/images/background.png) \
        $$quote($$BASEDIR/assets/images/background_blurred.png) \
        $$quote($$BASEDIR/assets/images/orange.png) \
        $$quote($$BASEDIR/assets/images/pear.png) \
...
config_pri_source_group1 {
    SOURCES += \
        $$quote($$BASEDIR/src/ProfileBoxManager.cpp) \
        $$quote($$BASEDIR/src/RegistrationHandler.cpp) \
        $$quote($$BASEDIR/src/main.cpp)

    HEADERS += \
        $$quote($$BASEDIR/src/ProfileBoxManager.hpp) \
