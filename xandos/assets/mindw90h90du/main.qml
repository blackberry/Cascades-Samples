...
Page {
    ...
    property int gridMaxHeight: ui.du(60)
    property int gridMaxWidth: ui.du(60)
    
    property int spriteMaxHeight: ui.du(15)
    property int spriteMaxWidth: ui.du(15)
    ...
    Container {
        ...
        Container {
            preferredHeight: gameGrid.maxHeight
            preferredWidth: gameGrid.maxWidth
            horizontalAlignment: HorizontalAlignment.Center
            verticalAlignment: VerticalAlignment.Center
            Container {
                //minWidth: ui.du(26.6)
