...
void StockCurveRecipe::createAnimatedEgg(Container *parent)
{
  ...
  mAnim = SequentialAnimation::create(mEgg).add(FadeTransition::create(mEgg).to(0)).add(
      TranslateTransition::create(mEgg).toY(0)).add(FadeTransition::create(mEgg).to(1.0f)).add(
      mEaseAnim).parent(this);
