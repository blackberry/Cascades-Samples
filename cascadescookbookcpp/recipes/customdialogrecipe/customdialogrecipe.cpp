    ...
    CustomControl(parent)
{
  ...
  ImageView *flame = ImageView::create(
      "asset:///images/customdialog/flame.png");
  ...
  ImageView *candle = ImageView::create(
      "asset:///images/customdialog/background.png");
  ...
  connect(mAlarmDialog, SIGNAL(visibleChanged(bool)), this,
      SLOT(onDialogVisible(bool)));
