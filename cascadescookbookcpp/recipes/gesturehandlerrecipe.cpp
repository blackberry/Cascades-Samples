    ...
    CustomControl(parent)
{
  ...
  DoubleTapHandler::create().onDoubleTapped(this,
      SLOT(onDoubleTap(bb::cascades::DoubleTapEvent*)));

  LongPressHandler *longPressHandler = LongPressHandler::create().onLongPressed(
      this, SLOT(onLongPress(bb::cascades::LongPressEvent*)));
