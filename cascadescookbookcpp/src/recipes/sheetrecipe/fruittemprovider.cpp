...
FruitItemProvider::FruitItemProvider(QObject *parent) : ListItemProvider(parent)
{
}

VisualNode * FruitItemProvider::createItem(ListView* list, const QString &type)
{
...
void FruitItemProvider::updateItem(ListView* list, bb::cascades::VisualNode *listItem,
