 ...
 */
#ifndef _FRUITITEMPROVIDER_H_
#define _FRUITITEMPROVIDER_H_
 ...
 */
class FruitItemProvider: public bb::cascades::ListItemProvider
{
public:
    FruitItemProvider(QObject *parent = 0);
...
#endif // ifndef _FRUITITEMPROVIDER_H_
