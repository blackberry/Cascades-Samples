    ...
    Container {
        ...
        Container {
                ...
                attachedObjects: [
                    LayoutUpdateHandler {
                        onLayoutFrameChanged: {
                            // Update the max position of the tooltip which depends on the slider width.
                            tooltipcontainer.maxTranslationX = layoutFrame.width - 60
                        }
                    }
                ]
            }
            ...
            Container {
                ...
                property int maxTranslationX: 0
                clipContentToBounds: false
                translationX: -108 + maxTranslationX * posValue // The x position is determined by the slider handle.
                translationY: -100
