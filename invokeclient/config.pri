...
config_pri_assets {
    OTHER_FILES += \
        $$quote($$BASEDIR/assets/QueryResultSheet.qml) \
        $$quote($$BASEDIR/assets/images/background.png) \
        $$quote($$BASEDIR/assets/images/icon.png) \
        $$quote($$BASEDIR/assets/images/invoke.png) \
        $$quote($$BASEDIR/assets/images/light.png) \
        $$quote($$BASEDIR/assets/images/menuinvoke.png) \
        $$quote($$BASEDIR/assets/images/nolight.png) \
        $$quote($$BASEDIR/assets/images/query.png) \
