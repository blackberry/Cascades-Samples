...
NOTE: There is another sample called InvokeTarget2 which is identical to this. If both targets are installed on the device, InvokeClient is able to demo the UX when there are two targets for a target filter.^M
