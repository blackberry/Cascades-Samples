...
Your existing UI could be displayed as result of the RegistrationHandler::registrationFinished() signal.


BEFORE YOU RUN THIS SAMPLE
Edit main.cpp and set your UUID (Universally unique identifier).
DO NOT USE THE EXAMPLE UUID IN THIS SAMPLE.
